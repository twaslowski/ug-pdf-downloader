...
class UgDataParserTest(unittest.TestCase):
    def test_should_return_false_if_url_contains_pro(self):
        ...
        self.assertEqual(False, ug_data_retriever._song_url_does_not_contain_pro_keyword(pro_url))
    ...
    def test_should_return_true_if_url_does_not_contain_pro(self):
        ...
        self.assertEqual(True, ug_data_retriever._song_url_does_not_contain_pro_keyword(normal_url))
